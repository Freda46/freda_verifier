...
/// Weight functions needed for `pallet_freda_verifier`.
...
impl WeightInfo for () {
    ...
    /// Proof: `SettlementFRedaPallet::Tickets` (`max_values`: None, `max_size`: Some(97), added: 2572, mode: `MaxEncodedLen`)
