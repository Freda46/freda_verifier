...
fn pallet_freda() {
    test().execute_with(|| {
        ...
        let dummy_proof: pallet_freda_verifier::Proof = [0; pallet_freda_verifier::PROOF_SIZE];
        let dummy_pubs: pallet_freda_verifier::Pubs = [0; pallet_freda_verifier::PUBS_SIZE];
        assert!(SettlementFRedaPallet::submit_proof(
