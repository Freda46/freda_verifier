...
impl pallet_verifiers::Config<pallet_freda_verifier::Freda> for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type OnProofVerified = Aggregate;
    type WeightInfo =
        pallet_freda_verifier::FredaWeight<weights::pallet_freda_verifier::ZKVWeight<Runtime>>;
...
construct_runtime!(
    pub struct Runtime {
        ...
        SettlementFRedaPallet: pallet_freda_verifier = 166,
...
mod benches {
    define_benchmarks!(
        ...
        // verifiers
        [pallet_freda_verifier, FredaVerifierBench::<Runtime>]
...
impl_runtime_apis! {
    ...
    impl frame_benchmarking::Benchmark<Block> for Runtime {
        fn benchmark_metadata(extra: bool) -> (
            ...
            use pallet_freda_verifier::benchmarking::Pallet as FredaVerifierBench;
